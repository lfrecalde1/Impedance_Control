...
export_fig Results_Impedance.pdf -q101
...
%hTitle_1 = title({'$\textrm{(c)}$'},'fontsize',14,'interpreter','latex','Color',C18);
%xlabel('$\textrm{Time}[s]$','fontsize',10,'interpreter','latex','Color',C18);
ylabel('$\textrm{Force Enviroment}$','fontsize',10,'interpreter','latex', 'Color',C18);
...
%% Data generation
V_plot = line(t,V(1, 1:length(t)));
set(V_plot, 'LineStyle', '--', 'Color', c4, 'LineWidth', lw);
...
%hTitle_1 = title({'$\textrm{(c)}$'},'fontsize',14,'interpreter','latex','Color',C18);
%xlabel('$\textrm{Time}[s]$','fontsize',10,'interpreter','latex','Color',C18);
ylabel('$\textrm{Potential Fiedl}$','fontsize',10,'interpreter','latex', 'Color',C18);

%% Legend nomeclature
hLegend_9 = legend([V_plot],{'$V$'},'fontsize',10,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_Impedance_tracking.pdf -q1
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_Impedance_Forces.pdf -q1
